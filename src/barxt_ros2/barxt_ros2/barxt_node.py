...
class BarXTNode(Node):
    ...
    def _diagnostic_status(self, stat):
        ...
        stat.add("total_samples", self.total_samples)
        stat.add("valid_samples", self.valid_samples)
        stat.add("invalid_samples", self.invalid_samples)
        stat.add("driver_errors", self.driver_errors)
        return stat
